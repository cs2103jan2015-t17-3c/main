...
string Logic::executeLogicCore(string userInput) {
	...
	string displayMessage = storage.addNormalTask(commandDetails[indexToUpdate]->task, commandDetails[indexToUpdate]->timeStart ,commandDetails[indexToUpdate]->timeEnd); 
	return displayMessage;
}
